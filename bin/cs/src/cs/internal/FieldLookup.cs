...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 4745537, 5442204, 5594513, 46374763, 57476627, 76061764, 78945784, 87367608, 142301684, 221637784, 243225909, 288167040, 312752480, 328878574, 359333139, 407283053, 452737314, 493819893, 501039929, 520590566, 572311959, 630156697, 746281503, 834174833, 863972113, 946786476, 1058556349, 1067353468, 1103412149, 1177754921, 1181037546, 1204816148, 1214453688, 1224901875, 1228056441, 1247875546, 1257164128, 1273207865, 1280845662, 1282943179, 1352786672, 1398464674, 1431819701, 1436822557, 1450317436, 1460447810, 1532710347, 1620824029, 1621420777, 1623148745, 1705629508, 1763375486, 1768617329, 1825849507, 1873474154, 1915412854, 1916009602, 1937159360, 2025055113, 2054707467, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"b", "__a", "map", "pop", "readAll", "getEnumConstructs", "remove", "__previousException", "filter", "resize", "__nativeException", "readBytes", "stream", "get_native", "iterator", "lastIndexOf", "hasNext", "reverse", "getBytes", "insert", "length", "native", "array", "contains", "value", "__nativeStack", "toString", "_eof", "splice", "copy", "__skipStack", "join", "concat", "close", "next", "enumConstructor", "push", "keyValueIterator", "current", "sort", "quicksort", "spliceVoid", "getEnumName", "createEnumIndex", "createEnum", "parseInt", "__ownStack", "concatNative", "__unsafe_get", "__unsafe_set", "indexOf", "toDynamic", "readByte", "allEnums", "unwrap", "readLine", "__get", "__set", "__hx_deleteField", "unshift", "enumParameters", "shift", "slice"};
