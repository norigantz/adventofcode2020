...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 105, 109, 1821933, 4745537, 4949376, 5144726, 5393365, 5442204, 5594513, 5741474, 24046298, 42740551, 46374763, 52644165, 57476627, 76061764, 78945784, 87367608, 142301684, 159136996, 208459108, 221637784, 243225909, 288167040, 312752480, 328878574, 359333139, 407283053, 452737314, 480756972, 493819893, 501039929, 520590566, 572311959, 614073432, 630156697, 746281503, 834174833, 863972113, 922671056, 946786476, 995006396, 1058556349, 1067353468, 1071652316, 1103412149, 1177754921, 1181037546, 1204816148, 1213952397, 1214453688, 1224901875, 1228056441, 1247875546, 1257164128, 1273207865, 1280549057, 1280845662, 1282943179, 1313416818, 1352786672, 1395555037, 1398464674, 1431819701, 1436822557, 1450317436, 1460447810, 1532710347, 1537812987, 1620824029, 1621420777, 1623148745, 1639293562, 1705629508, 1723805383, 1763375486, 1768617329, 1825849507, 1873474154, 1915412854, 1916009602, 1937159360, 2022294396, 2025055113, 2048392659, 2054707467, 2082663554, 2083500811, 2127021138};
		
		protected static string[] fields = new string[]{"b", "i", "m", "isGlobal", "__a", "cur", "get", "len", "map", "pop", "set", "split", "flags", "readAll", "match", "getEnumConstructs", "remove", "__previousException", "filter", "resize", "matched", "parseString", "__nativeException", "readBytes", "stream", "get_native", "iterator", "lastIndexOf", "hasNext", "reverse", "nOccupied", "getBytes", "insert", "length", "native", "matchedRight", "array", "contains", "value", "__nativeStack", "cachedIndex", "toString", "hashes", "_eof", "splice", "exists", "copy", "__skipStack", "join", "concat", "clear", "close", "next", "enumConstructor", "push", "keyValueIterator", "current", "size", "sort", "quicksort", "vals", "spliceVoid", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "parseInt", "__ownStack", "concatNative", "nBuckets", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "toDynamic", "regex", "readByte", "allEnums", "unwrap", "readLine", "__get", "__set", "__hx_deleteField", "upperBound", "unshift", "_keys", "enumParameters", "shift", "matchedLeft", "slice"};
